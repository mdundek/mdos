...
running command...
$ mdos (--version)
mdos-cli/2.0.1 darwin-x64 node-v18.9.0
$ mdos --help [COMMAND]
USAGE
  $ mdos COMMAND
...
...
_See code: [dist/commands/install-framework.ts](https://github.com/mdos-cli/hello-world/blob/v2.0.1/dist/commands/install-framework.ts)_
...
_See code: [dist/commands/login.ts](https://github.com/mdos-cli/hello-world/blob/v2.0.1/dist/commands/login.ts)_
...
_See code: [dist/commands/logout.ts](https://github.com/mdos-cli/hello-world/blob/v2.0.1/dist/commands/logout.ts)_
...
_See code: [dist/commands/set-kubeconfig.ts](https://github.com/mdos-cli/hello-world/blob/v2.0.1/dist/commands/set-kubeconfig.ts)_
...
_See code: [dist/commands/status.ts](https://github.com/mdos-cli/hello-world/blob/v2.0.1/dist/commands/status.ts)_
