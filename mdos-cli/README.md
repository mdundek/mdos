...
running command...
$ mdos (--version)
mdos-cli/1.0.18 darwin-x64 node-v18.9.0
$ mdos --help [COMMAND]
USAGE
  $ mdos COMMAND
...
...
_See code: [dist/commands/get-config.ts](https://github.com/mdos-cli/hello-world/blob/v1.0.18/dist/commands/get-config.ts)_
...
_See code: [dist/commands/login.ts](https://github.com/mdos-cli/hello-world/blob/v1.0.18/dist/commands/login.ts)_
...
_See code: [dist/commands/logout.ts](https://github.com/mdos-cli/hello-world/blob/v1.0.18/dist/commands/logout.ts)_
