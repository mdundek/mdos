...
select_repos() {
    ...
    OPTIONS_VALUES=("ms" "okube" "cc" "helm-chart" "broker-client" "osp-logger")
    OPTIONS_LABELS=("Sync & Deploy Job Microservice" "Okube API" "Control Center" "Generic Helm Chart" "RabbitMQ Broker Client Module" "OSP Logger Module")
...
select_components() {
    ...
    OPTIONS_VALUES=("sync-load" "sync-pull" "sync-push" "deploy" "okube" "cc")
    OPTIONS_LABELS=("Sync-load Job Microservice" "Sync-pull Job Microservice" "Sync-push Job Microservice" "Deploy Job Microservice" "Okube API" "Control Center")
