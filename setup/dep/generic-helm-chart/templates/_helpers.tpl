...
*/}}
{{- define "stateless-helm.fullname" -}}
...
Common labels
*/}}
{{- define "stateless-helm.labels" -}}
helm.sh/chart: {{ include "stateless-helm.chart" . }}
{{ include "stateless-helm.selectorLabels" . }}
{{- if .Chart.AppVersion }}
